...
## Simulation Assumptions {.light-centered .center}
...
## Step 3: Grid Net Load Profile {.light-centered .center}
...
<table style="width: 100%; border-collapse: collapse; font-size: 28px; margin: 0;">
  <tbody>
    ...
    <tr>
      ...
      <td style="width: 80%; padding: 16px 14px; border-top: 1px solid #333; text-align: left;">a\. Stated preference being optimistic.<br>b\. Only considered single-family homes.<br>c\. Grid conditions based on today's data.</td>
    </tr>
  </tbody>
</table>
