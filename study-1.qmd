...
## <span style="color: #FFB84D;">Study 1</span><br>Electric Vehicle Smart Charging Adoption {.dark-centered .center}
...
::: {.centered-container}
We need high EV ownership & a large sample size.
:::

::: {.notes}
There have been a few studies that looked at people's willingness to participate in smart charging programs, but they all have small sample sizes and low EV ownership. Therefore, we aimed to conduct a large-scale survey with high EV ownership to study BEV owners' preferences.
:::
